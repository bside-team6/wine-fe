...
import {loginStep, loginKrTitle, loginKrStr, nickNameInputArea,  nickNameInput, nickNameInputStr, btnArea, btnConfirm} from 'styles/login';
// nTrue, nFalse, 
function SignupStep2() {
  ...
  const [str, setStr] = useState('2-16자 국문/영문 대소문자/숫자');
